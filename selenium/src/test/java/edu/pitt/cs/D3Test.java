...
public class D3Test {
  ...
  public void tEST2RESET() {
    ...
    assertThat(driver.findElement(By.xpath("//div/ul[contains(@class, \"list-group\")]/li[1]")).getText(), is("ID 1. Jennyanydots"));
    assertThat(driver.findElement(By.xpath("//div/ul[contains(@class, \"list-group\")]/li[2]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("//div/ul[contains(@class, \"list-group\")]/li[3]")).getText(), is("ID 3. Mistoffelees"));
  }
  @Test
  public void tEST3CATALOG() {
    ...
    {
      WebElement element = driver.findElement(By.xpath("//div/ol/li[2]/img"));
  ...
  public void tEST6RENT() {
    ...
    assertThat(driver.findElement(By.xpath("//div/ul[contains(@class, \"list-group\")]/li[1]")).getText(), is("Rented out"));
    assertThat(driver.findElement(By.xpath("//div/ul[contains(@class, \"list-group\")]/li[2]")).getText(), is("ID 2. Old Deuteronomy"));
    assertThat(driver.findElement(By.xpath("//div/ul[contains(@class, \"list-group\")]/li[3]")).getText(), is("ID 3. Mistoffelees"));
